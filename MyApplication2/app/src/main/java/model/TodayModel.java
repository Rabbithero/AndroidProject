...
public class TodayModel {
    ...
    private String wind; /*"西南风微风",*/
    private String dressing_index;/*": "较冷", /*穿衣指数*/
    private String dressing_advice;/*": "建议着大衣、呢外套加毛衣、卫衣等服装。",	/*穿衣建议*/
    private String uv_index;/*": "中等",	/*紫外线强度*/
    private String comfort_index;/*": "",/*舒适度指数*/
    private String wash_index;/*": "较适宜",	/*洗车指数*/
    private String travel_index;/*": "适宜",	/*旅游指数*/
    private String exercise_index;/*": "较适宜",	/*晨练指数*/
    private String drying_index;/*": ""/*干燥指数*/
//     fa;	/*天气标识00：晴*/
//     fb;	/*天气标识53：霾 如果fa不等于fb，说明是组合天气*/
